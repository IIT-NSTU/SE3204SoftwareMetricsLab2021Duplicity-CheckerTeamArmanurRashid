...
public class Basic_Frame_Duplicity extends Frame_Container_Template{
   ...
   public void setPanel() {
    ...
    public void userinterface() {
        ...
        background.add(comparable_file_textarea);
        ...
        background.add(comparable_file_scrolltext);
        ...
        background.add(comparing_file_textarea);
        ...
        background.add(comparing_file_scrolltext);
    ...
    public JButton[] buttons() {
        ...
        file_read_button1.setBackground(new Color(54, 25, 189, 255));
        ...
        background.add(file_read_button1);
        ...
        file_read_button2.setBackground(new Color(106, 73, 198, 255));
        ...
        background.add(file_read_button2);
